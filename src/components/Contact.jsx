  ...
  return (
    <div name='contact' className='w-full h-screen flex flex-col justify-center items-center p-4 bg-main-body'>
      ...
      <form method='POST' action="https://getform.io/f/6920c939-1c12-46ff-baf7-ffa20dad9814" className='flex flex-col max-w-[600px] w-full'>
        ...
        <button className='text-white border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-2 sm:py-3 mt-4 sm:mt-8 mx-auto flex items-center'>Let's Collaborate</button>
      </form>
      <ul className='w-full flex justify-center space-x-8 mt-4 sm:mt-12'>
